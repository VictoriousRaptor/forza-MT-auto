...
parser.add_argument('--clutch', type=str, help='离合按键', default="shift")
...
parser.add_argument('--downGearCoolDown', type=float, help='降档的cd 连续降档间隔时长(秒)', default=0.1)
parser.add_argument('--upGearCoolDown', type=float, help='升档的cd 连续升档间隔时长(秒)', default=0.5)
